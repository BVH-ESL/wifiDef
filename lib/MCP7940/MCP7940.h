...
enum SqwPinMode { OFF = 0x00, ON = 0x80, SquareWave1HZ = 0x40, SquareWave4kHz = 0x41, SquareWave8kHz = 0x42, SquareWave32kHz = 0x43 };
...
class RTC_MCP7940{	//RTC functions, based off original library. Some functions are designed specifically for use in the
  ...
  static void setAlarm0Sec(uint8_t value);
  static uint8_t readSqwPinMode();
